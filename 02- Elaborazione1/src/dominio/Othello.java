...
public class Othello {
   ...
   /* public void caricaPrenotazione(){
        Stanza s1 = new Stanza("1", "singola", 1.1f);
        Prenotazione p1 = new Prenotazione("1", Date.valueOf("2021-11-12"), Date.valueOf("2021-11-13"), s1);
        this.prenotazioni.add(p1);
        Stanza s2 = new Stanza("2", "singola", 1.2f);
        Prenotazione p2 = new Prenotazione("2", Date.valueOf("2021-12-13"), Date.valueOf("2021-12-14"), s2);
        this.prenotazioni.add(p2);
    }*/
    ...
    public List<Stanza> visualizzaStanze(String tipologia, Date data_inizio, Date data_fine) {
        ...
        for (Stanza s : this.stanze) {
            if (tipologia.equals(s.getTipologia())) {
